...
static uint64_t __bot_procman_deputy_cmd2_t_hash;
...
uint64_t __bot_procman_deputy_cmd2_t_hash_recursive(const __lcm_hash_ptr *p)
{
    ...
    __lcm_hash_ptr cp;
    cp.parent =  p;
    cp.v = __bot_procman_deputy_cmd2_t_get_hash;
    (void) cp;

    uint64_t hash = (uint64_t)0x0e86006ec5c7fbaaLL
...
int64_t __bot_procman_deputy_cmd2_t_get_hash(void)
{
    if (!__bot_procman_deputy_cmd2_t_hash_computed) {
        __bot_procman_deputy_cmd2_t_hash = (int64_t)__bot_procman_deputy_cmd2_t_hash_recursive(NULL);
