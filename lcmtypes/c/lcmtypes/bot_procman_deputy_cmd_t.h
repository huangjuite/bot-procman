 ...
 */
typedef void(*bot_procman_deputy_cmd_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const bot_procman_deputy_cmd_t *msg, void *userdata);
 ...
 */
bot_procman_deputy_cmd_t_subscription_t* bot_procman_deputy_cmd_t_subscribe(
    lcm_t *lcm, const char *channel, bot_procman_deputy_cmd_t_handler_t handler, void *userdata);
 ...
 * @return 0 on success, <0 if an error occured
 */
int bot_procman_deputy_cmd_t_subscription_set_queue_capacity(
    bot_procman_deputy_cmd_t_subscription_t* subs, int num_messages);
...
int __bot_procman_deputy_cmd_t_encode_array(
    void *buf, int offset, int maxlen, const bot_procman_deputy_cmd_t *p, int elements);
int __bot_procman_deputy_cmd_t_decode_array(
    const void *buf, int offset, int maxlen, bot_procman_deputy_cmd_t *p, int elements);
